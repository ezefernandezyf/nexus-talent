...
POST /api/ai/analyze MUST accept `analysisRequestSchema`-validated body and persist the result to the database after Groq returns. Persistence is best-effort and MUST NOT fail the request on save error.
