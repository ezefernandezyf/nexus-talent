  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
      <div className="space-y-4">
        <button
          type="button"
          className="w-full flex items-center justify-center gap-3 rounded-xl bg-white px-4 py-3 font-semibold text-on-surface transition-opacity duration-200 hover:opacity-90"
        ...
        <button
          type="button"
          className="w-full flex items-center justify-center gap-3 rounded-xl border border-surface-container bg-white p-0.5 text-on-surface transition-opacity duration-200 hover:opacity-90"
          disabled={isOAuthSubmitting || !isConfigured}
          onClick={() => handleOAuthSignIn("google")}
        >
          <span className="flex items-center gap-3 px-4 py-3 text-on-surface">
            ...
            <span className="font-headline tracking-tight text-on-surface">{isOAuthSubmitting ? "Redirigiendo..." : "Continuar con Google"}</span>
          </span>
        </button>
      </div>
