  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4 py-8 text-[var(--text-primary)] sm:px-6 lg:px-8">
      <Card className="flex w-full max-w-xl flex-col gap-4 p-6 text-center sm:p-8">
        <Badge className="mx-auto">500</Badge>
        <h1 className="text-3xl font-semibold tracking-[-0.03em] text-[var(--text-primary)] sm:text-4xl">Error interno del servidor</h1>
        ...
        <div className="flex flex-wrap justify-center gap-3 pt-2">
          <Button variant="filled" type="button" onClick={() => window.location.reload()}>
            Recargar aplicación
          </Button>
        </div>
      </Card>
