...
export default function PrivacyPage() {
  ...
  return (
    <main className="min-h-screen px-4 py-8 text-[var(--color-on-surface)] sm:px-6 lg:px-8">
      <Card variant="flat" className="mx-auto flex w-full max-w-4xl flex-col gap-5 p-6 sm:p-8">
        ...
        <h1 className="text-3xl font-semibold tracking-[-0.03em] text-[var(--color-on-surface)] sm:text-4xl">Privacidad y manejo de datos</h1>
