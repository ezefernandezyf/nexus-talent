  ...
  return (
    ...
    >
      <Link
        ...
        className="absolute inset-0 z-0 rounded-xl outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]/40"
      ...
      <div className="flex min-w-0 items-start gap-4 lg:col-span-4 lg:items-center">
        <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-outline-variant/20 bg-surface-container-lowest">
          <span className="material-symbols-outlined text-[var(--accent)]" aria-hidden="true">
            {iconName}
          </span>
        </div>
        <div className="min-w-0">
          ...
          <p className="truncate font-label text-[10px] tracking-widest text-[var(--accent)]/70" title={uidLabel}>
            {uidLabel}
          </p>
        </div>
      </div>
