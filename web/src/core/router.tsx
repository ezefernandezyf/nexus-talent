...
const UnifiedPage = lazy(() => import("@/features/cv/pages/UnifiedPage").then((module) => ({ default: module.UnifiedPage })));
        ...
        >
          <Routes location={location}>
            ...
            <Route element={<AppLayout />} path="/app">
              <Route index element={<Navigate replace to="cv" />} />
              <Route path="analysis" element={<Navigate replace to="/app/cv" />} />
              ...
              <Route element={<ProtectedRoute />} path="cv">
                <Route index element={<UnifiedPage />} errorElement={<RouteErrorFallback />} />
              </Route>
